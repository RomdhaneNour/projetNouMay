        ...
        <div class="col-md-8">
            ...
            <div> <a href='/gestionpfe' class="	fas fa-arrow-left"></a></div>
                ...
                @if(Session::has('message')) 
                    ...
                    <form action='/edit/{{$pFE->id}}' method='POST' name="f">
        @csrf
        
        <div class="form-group">
    <label for="exampleFormControlInput1">titre</label>
    <input type="text" class="form-control"  value='{{$pFE->titre}}' name='titre'>
        </div>
        <div class="form-group">
    <label for="exampleFormControlTextarea1">sujet</label>
    <textarea class="form-control"  rows="3" name='sujet'>{{$pFE->sujet}}</textarea>
        </div>
